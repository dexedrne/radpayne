/**
 * Retarget humanoid clips from a plain glTF rig (the Radbro rig / Mixamo naming) onto a
 ...
 *  - that example assumes the source rest pose is a T-pose. The Radbro
...
/** The Radbro rig (RadRun game characters): Hips > Spine02 > Spine01 > Spine > neck > Head. */
