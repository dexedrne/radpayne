...
/** Over-the-right-shoulder pivot: height above the feet, offset to the camera's right. */
export const SHOULDER = { up: 1.55, right: 0.6, arm: 2.7, lyingUp: 0.85, minArm: 0.5 } as const;
