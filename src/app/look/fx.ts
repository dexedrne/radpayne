...
/** What the active room look draws itself (FxView skips it): the street look draws the tracers (gold for him, red for the gang). */
export const lookOwns = { tracers: false };
